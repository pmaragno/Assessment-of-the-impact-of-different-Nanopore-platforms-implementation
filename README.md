...
* path_output = path to the directory where saving the overlapping plots
...
* output_pdf_file = path to the pdf file in which saving the histogram with the mean coverage distribution for each condition
* output_pdf_file_500x = path to the pdf file in which saving the histogram with the mean coverage distribution for each condition (saturation at 500x)
